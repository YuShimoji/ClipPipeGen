...
## INT-02d yt-dlp-audio receipt contract

INT-02d は spec only。実 `yt-dlp-audio` mode はまだ CLI に追加しない。実装する後続 slice では [YTDLP_AUDIO_SPEC.md](../../YTDLP_AUDIO_SPEC.md) に従い、receipt に次を残す。
