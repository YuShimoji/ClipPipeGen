...
OUT-01c/OUT-01d で取得済み source video / source audio / edit_pack subtitle draft は diagnostic visual proof と timing/filter readback に接続済み。次に進む場合も、production render、subtitle design hardening、GUI action、URL video fetch はさらに別 slice に分ける。
