...
Editing タブの action form は **ED-01 / ED-02a の手動 cut 入力範囲だけ** GUI に出す。ED-02 `generate-cuts`、ED-03 `check-cut-context`、ED-04 `generate-subtitles`、ED-06 `export-nle` は CLI 実装済みだが、GUI button はまだ置かない。
