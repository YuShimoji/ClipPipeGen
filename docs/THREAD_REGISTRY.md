...
| `clip-out-02-local-fixture-output-proof-smoke-v0` | `OUT-02` | queued local fixture proof smoke | `ClipPipeGen` | recommended: branch from `codex/int-01-parallel-lane-aggregation-v0` | n/a | next terminal/worktree | TBD | W5 | queued | none yet; depends on accepted INT-01 base | Prove local fixture output path without source fetch, external auth, or public upload |
