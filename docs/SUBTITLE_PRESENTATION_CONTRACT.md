...
## Current ED-10al Final Render-Path Stage 3 Diagnostic Rehearsal

ED-10al records `clip-ed10al-final-render-path-stage-3-rehearsal-001` as a
tracked stage-3 diagnostic rehearsal at
...
as the replayability source, preserves ED-10af as the active diagnostic proof
source, and uses ED-10ag/ED-10ah/ED-10ai/ED-10aj as lineage, gate, readiness,
and selected-path support.

The ED-10al rehearsal first checked for reusable ignored outputs. The required
same-machine source video/audio were present and the ignored ASS/MP4/local
manifest outputs were absent, so this slice generated a bounded diagnostic
FFmpeg/libass rehearsal under ignored `episodes/` paths. The ASS, MP4, and local
manifest were generated; the contact sheet path remains recorded but was not
generated by this stage-3 rehearsal function. ED-10al preserves the stable body
text policy, badge/accent/backplate route, line-break/safe-area metadata, and
style-token survival readback. It is still diagnostic-only: production subtitle
