...
| ED-10w | Subtitle Presentation Review Pack v0 | done | subtitle_presentation_review_pack_ready | 100 | clip-ed10w-subtitle-presentation-review-pack-001 | Use the one-pass review pack to choose baseline/pass, a bounded decoration adjustment, or the next tiny render-path diagnostic probe. |
