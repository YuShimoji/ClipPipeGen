...
| `src/integrations/render/` | OUT-01 tiny diagnostic render、OUT-04 bounded editorial sequence、OUT-05/06 vertical internal candidate、OUT-07 accepted-baseline operator package、OUT-08 unused-range minibatch、OUT-09 second-source repeatability、OUT-10 third-source candidate / 3-source scorecard。OUT-10は取得済みsource/caption/planのauthority、distinct identity、全景neutral-matte policy、media/audio/frame/manifest/readbackを担当する | URL / VOD取得、STT、自動cut候補採択、rights判断、human acceptance、production subtitle/design/render acceptance、GUI action、upload、thumbnail upload、visibility、made-for-kids、publishing |
