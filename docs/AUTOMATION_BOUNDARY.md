...
| `src/integrations/render/` | OUT-01 tiny diagnostic render、OUT-04 bounded editorial representative sequence、OUT-05 accepted-timeline vertical internal candidate、OUT-06 complete narrative internal delivery candidate、OUT-07 accepted-baseline native-cover operator package。OUT-07は固定SHAのbaseline byte copy、動画frame抽出、一覧/4:5 preview、unchanged metadata、acceptance/gate/provenance/determinism/manifest readbackだけを担当する | 受理済みbaselineのrender/remux/transcode/edit/retime、URL / VOD / reference pixel取得、STT、cut 候補抽出、production subtitle design、GUI action、production render acceptance、upload、thumbnail upload、visibility、made-for-kids、publishing |
