...
Fetch and switch to the OUT-05 review branch, then read the project context:
...
The durable OUT-05 state is a tracked builder/CLI/test/contract plus one ignored
