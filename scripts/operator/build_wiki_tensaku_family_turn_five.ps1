...
$artifactId = "clip-wiki-tensaku-family-turn-v5-001"
$videoId = "1AcId5Yja10"
...
$turnFourEditPack = Join-Path $EpisodeDir "artifacts/clip-wiki-tensaku-family-turn-v4-001/edit_pack.json"
...
try {
    node src/integrations/asset_fetch/wiki_tensaku_corpus.mjs `
        ...
        --selection-profile scarcity-aware-mixed `
        ...
        --exclude-edit-pack $turnFourEditPack
    if ($LASTEXITCODE -ne 0) { throw "wiki-tensaku fifth scarcity-aware retained-source planning failed with exit code $LASTEXITCODE" }
