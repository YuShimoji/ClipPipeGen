...
$artifactId = "clip-wiki-tensaku-family-turn-v3-001"
$videoId = "1AcId5Yja10"
...
try {
    ...
    if ($LASTEXITCODE -ne 0) { throw "wiki-tensaku third uncovered retained-source planning failed with exit code $LASTEXITCODE" }
