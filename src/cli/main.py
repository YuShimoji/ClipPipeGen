...
Subcommands:
    ...
    build-edit-ready-source-packet URL/local media -> provenance-bound edit-ready Source Packet.
...
from . import (
    ...
    build_real_video,
    build_edit_ready_source_packet,
...
SUBCOMMANDS: dict[str, Callable[[list[str]], int]] = {
    ...
    "build-edit-ready-source-packet": build_edit_ready_source_packet.run,
