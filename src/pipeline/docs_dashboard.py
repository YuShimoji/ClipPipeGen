    ...
    return {
        ...
        "current_focus": {'feature_id': 'ED-10ax',
         ...
         'subtitle_internal_review_video_candidate_access_sheet': {'status': 'ready_for_optional_user_review',
                                                                            ...
                                                                            'youtube_publish_package_created': False,
                                                                            'episodes_tracked': False},
         'subtitle_internal_review_video_observation_readback': {'status': 'internal_review_observation_readback_ready',
                                                                            'artifact_id': 'clip-ed10at-internal-review-observation-readback-001',
                                                                            'metadata_json': 'docs/style_intent/internal-review-video-observation-readback.json',
                                                                            ...
                                                                            'active_diagnostic_proof_source_artifact_id': 'clip-ed10af-l2-render-path-selector-probe-001',
                                                                            'openability': 'pass',
                                                                            'duration': 'expected_pass',
                                                                            'subtitle_cue_coverage': 'pass_for_diagnostic_cue_probe',
                                                                            'subtitle_cues': ['NORMAL DIALOGUE CUE',
                                                                                              'SHOUT HIGH INTENSITY',
                                                                                              'LOW PRESSURE WHISPER CUE'],
                                                                            'narrative_video_continuity': 'warning_not_representative_review',
                                                                            'memo_like_appearance': 'warning_observed',
                                                                            'review_guidance_clarity': 'partial_or_fail',
                                                                            'artifact_semantics': 'diagnostic_subtitle_render_path_cue_probe_not_representative_episode_review',
                                                                            'stale_checkout_anchor_repaired': True,
                                                                            'recommended_next_axis': 'representative-micro-scene-internal-review-specimen',
                                                                            'alternate_next_axis': 'final-render-path-stage-4_only_for_concrete_render_diagnostic_gap',
         ...
         'subtitle_representative_micro_scene_internal_review_specimen': {'status': 'representative_micro_scene_internal_review_specimen_ready',
                                                                            'artifact_id': 'clip-ed10au-representative-micro-scene-internal-review-specimen-001',
                                                                            'metadata_json': 'docs/style_intent/representative-micro-scene-internal-review-specimen.json',
                                                                            ...
                                                                            'source_subtitle_ids': ['sub_004',
                                                                                                    'sub_005',
                                                                                                    'sub_006'],
                                                                            'actual_script_content_present': True,
                                                                            'cue_labels_used_as_main_content': False,
                                                                            'forbidden_cue_labels': ['NORMAL DIALOGUE CUE',
                                                                                                     'SHOUT HIGH INTENSITY',
                                                                                                     'LOW PRESSURE WHISPER CUE'],
                                                                            'script_event_count': 3,
         ...
         'subtitle_micro_scene_observation_frame_readback': {'status': 'micro_scene_observation_frame_readback_ready',
                                                             ...
                                                             'monetization_acceptance': False,
                                                             'user_observation_converted_to_approval': False},
         'grill_me_adoption_review_frame_clarification_plan': {'status': 'grill_me_adoption_readback_and_review_frame_clarification_plan_ready',
                                                               'artifact_id': 'clip-ed10aw-grill-me-adoption-readback-and-review-frame-clarification-plan-001',
                                                               'metadata_json': 'docs/style_intent/grill-me-adoption-readback-and-ed10aw-review-frame-clarification-plan.json',
                                                               'doc': 'docs/style_intent/grill-me-adoption-readback-and-ed10aw-review-frame-clarification-plan.md',
                                                               ...
                                                               'grill_me_skill_path': '.agents/skills/grill-me/SKILL.md',
                                                               'grill_me_skill_git_state': 'untracked_do_not_stage',
                                                               ...
                                                               'adoption_verdict': 'PASS',
                                                               'call_gates': ['plan_grill',
                                                                              'diff_grill',
                                                                              'report_grill',
                                                                              'observation_grill'],
                                                               'verdict_enum': ['PASS',
                                                               ...
                                                               'warnings_max': 3,
                                                               'required_fix_max': 3,
                                                               'forbidden_outputs': ['next_agent_prompt',
                                                               ...
                                                               'required_fix': ['do_not_stage_grill_me_skill_or_skills_lock',
                                                                                'cap_outputs_to_verdict_blockers_warnings_required_fix',
                                                                                'fall_back_to_ordinary_project_gates_if_skill_is_unavailable'],
                                                               'ed10aw_route_id': 'review-frame-clarification',
                                                               'ed10aw_direction_status': 'review_frame_clarification_plan_ready',
                                                               ...
                                                               'review_frame_needs_to_answer': ['what_this_surface_is',
                                                               ...
                                                               'recommended_future_look_for_points': ['Is the review target understandable as a micro-scene review surface?',
                                                               ...
                                                               'route_separation': {'review_frame_clarification': 'first_default',
